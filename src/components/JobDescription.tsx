    ...
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      {isEditing ? (
        <textarea
          ...
          className="w-full h-96 p-4 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"
          placeholder="Paste the job description here..."
        />
      ) : (
        <div className="prose max-w-none">
          <div className="whitespace-pre-wrap font-mono text-sm">{description}</div>
        </div>
      )}
    </div>
  );
